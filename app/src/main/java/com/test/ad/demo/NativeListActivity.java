...
public class NativeListActivity extends Activity {
    ...
    ATNativeNetworkListener nativeNetworkListener = new ATNativeNetworkListener() {
        ...
        public void onNativeAdLoaded() {
            ...
            Toast.makeText(NativeListActivity.this, "[原生List] onNativeAdLoaded", Toast.LENGTH_SHORT).show();
        }

        @Override
        public void onNativeAdLoadFail(AdError adError) {
            Log.e(TAG, "native ad onNativeAdLoadFail------------- " + adError.getFullErrorInfo());
            Toast.makeText(NativeListActivity.this, "[原生List] onNativeAdLoadFail: " + (adError != null ? adError.getFullErrorInfo() : ""), Toast.LENGTH_SHORT).show();
        }
    };
