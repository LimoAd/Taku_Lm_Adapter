...
//        super.onBackPressed();
    ...
    public void onDeeplinkCallback(ATAdInfo adInfo, boolean isSuccess) {
        ...
        Toast.makeText(getApplicationContext(), "[开屏] onDeeplinkCallback: isSuccess=" + isSuccess, Toast.LENGTH_SHORT).show();
    }
...
//        }));
    ...
    public void onAdLoaded(boolean isTimeout) {
        ...
        Toast.makeText(getApplicationContext(), "[开屏] onAdLoaded: isTimeout=" + isTimeout, Toast.LENGTH_SHORT).show();
...
//        showAdWithCustomSkipView();//show with customSkipView
    ...
    public void onNoAdError(AdError adError) {
        ...
        Toast.makeText(getApplicationContext(), "[开屏] onNoAdError: " + (adError != null ? adError.getFullErrorInfo() : ""), Toast.LENGTH_SHORT).show();
        jumpToMainActivity();
    }
    ...
    public void onAdShow(ATAdInfo entity) {
        Log.i(TAG, "onAdShow:\n" + entity.toString());
        Toast.makeText(getApplicationContext(), "[开屏] onAdShow: " + (entity != null ? entity.toString() : ""), Toast.LENGTH_SHORT).show();
    }

    @Override
    public void onAdClick(ATAdInfo entity) {
        Log.i(TAG, "onAdClick:\n" + entity.toString());
        Toast.makeText(getApplicationContext(), "[开屏] onAdClick: " + (entity != null ? entity.toString() : ""), Toast.LENGTH_SHORT).show();
    }
    ...
    public void onAdDismiss(ATAdInfo entity, ATSplashAdExtraInfo splashAdExtraInfo) {
        ...
        Toast.makeText(getApplicationContext(), "[开屏] onAdDismiss: " + (entity != null ? entity.toString() : ""), Toast.LENGTH_SHORT).show();
