...
public class NativePatchVideoActivity extends Activity {
    ...
    ATNativeNetworkListener nativeNetworkListener = new ATNativeNetworkListener() {
        ...
        public void onNativeAdLoaded() {
            ...
            Toast.makeText(NativePatchVideoActivity.this, "[原生Patch] onNativeAdLoaded", Toast.LENGTH_SHORT).show();
            if (!hadBeenShowAd) {
        ...
        public void onNativeAdLoadFail(AdError adError) {
            Toast.makeText(NativePatchVideoActivity.this, "[原生Patch] onNativeAdLoadFail: " + (adError != null ? adError.getFullErrorInfo() : ""), Toast.LENGTH_SHORT).show();
            videoView.start();
        }
    };
    ...
    private void showAd(NativeAd nativeAd) {
        ...
        nativeAd.setNativeEventListener(new ATNativeEventExListener() {
            ...
            public void onDeeplinkCallback(ATNativeAdView view, ATAdInfo adInfo, boolean isSuccess) {
                ...
                Toast.makeText(NativePatchVideoActivity.this, "[原生Patch] onDeeplinkCallback: isSuccess=" + isSuccess, Toast.LENGTH_SHORT).show();
            }
            ...
            public void onAdClicked(ATNativeAdView view, ATAdInfo entity) {
                ...
                Toast.makeText(NativePatchVideoActivity.this, "[原生Patch] onAdClicked: " + (entity != null ? entity.toString() : ""), Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onAdVideoStart(ATNativeAdView view) {
                Log.i(TAG, "native ad onAdVideoStart");
                Toast.makeText(NativePatchVideoActivity.this, "[原生Patch] onAdVideoStart", Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onAdVideoEnd(ATNativeAdView view) {
                Log.i(TAG, "native ad onAdVideoEnd");
                Toast.makeText(NativePatchVideoActivity.this, "[原生Patch] onAdVideoEnd", Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onAdVideoProgress(ATNativeAdView view, int progress) {
                Log.i(TAG, "native ad onAdVideoProgress:" + progress);
                Toast.makeText(NativePatchVideoActivity.this, "[原生Patch] onAdVideoProgress: progress=" + progress, Toast.LENGTH_SHORT).show();
            }
        });
        ...
        nativeAd.setDislikeCallbackListener(new ATNativeDislikeListener() {
            ...
            public void onAdCloseButtonClick(ATNativeAdView view, ATAdInfo entity) {
                Toast.makeText(NativePatchVideoActivity.this, "[原生Patch] onAdCloseButtonClick: " + (entity != null ? entity.toString() : ""), Toast.LENGTH_SHORT).show();
