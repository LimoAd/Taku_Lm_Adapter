...
//                intent.putExtra("custom_skip_view", isCustomSkipViewCheckBox.isChecked());
    ...
    private class ATSplashExListenerImpl implements ATSplashExListener {
        ...
        public void onAdLoaded(boolean isTimeout) {
            ...
            showToast("[开屏] onAdLoaded: isTimeout=" + isTimeout);
        }
        ...
        public void onNoAdError(AdError adError) {
            ...
            showToast("[开屏] onNoAdError: " + (adError != null ? adError.getFullErrorInfo() : ""));
        }
        ...
        public void onAdShow(ATAdInfo entity) {
            ...
            showToast("[开屏] onAdShow: " + (entity != null ? entity.toString() : ""));
        }
        ...
        public void onAdClick(ATAdInfo entity) {
            ...
            showToast("[开屏] onAdClick: " + (entity != null ? entity.toString() : ""));
        }
        ...
        public void onAdDismiss(ATAdInfo entity, ATSplashAdExtraInfo splashAdExtraInfo) {
            ...
            showToast("[开屏] onAdDismiss: " + (entity != null ? entity.toString() : ""));
        }
        ...
        public void onDeeplinkCallback(ATAdInfo entity, boolean isSuccess) {
            ...
            showToast("[开屏] onDeeplinkCallback: isSuccess=" + isSuccess);
        }
