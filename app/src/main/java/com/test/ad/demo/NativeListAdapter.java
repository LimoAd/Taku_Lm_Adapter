    ...
    private void renderAdView(final NativeAd nativeAd, final AdViewHolder adViewHolder, int position) {
        nativeAd.setNativeEventListener(new ATNativeEventListener() {
            ...
            public void onAdImpressed(ATNativeAdView view, ATAdInfo entity) {
                ...
                Toast.makeText(view.getContext(), "[原生List] onAdImpressed: " + (entity != null ? entity.toString() : ""), Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onAdClicked(ATNativeAdView view, ATAdInfo entity) {
                Log.i(TAG, "native ad onAdClicked--------\n" + entity.toString());
                Toast.makeText(view.getContext(), "[原生List] onAdClicked: " + (entity != null ? entity.toString() : ""), Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onAdVideoStart(ATNativeAdView view) {
                Log.i(TAG, "native ad onAdVideoStart--------");
                Toast.makeText(view.getContext(), "[原生List] onAdVideoStart", Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onAdVideoEnd(ATNativeAdView view) {
                Log.i(TAG, "native ad onAdVideoEnd--------");
                Toast.makeText(view.getContext(), "[原生List] onAdVideoEnd", Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onAdVideoProgress(ATNativeAdView view, int progress) {
                Log.i(TAG, "native ad onAdVideoProgress--------:" + progress);
                Toast.makeText(view.getContext(), "[原生List] onAdVideoProgress: progress=" + progress, Toast.LENGTH_SHORT).show();
            }
        });
        ...
        nativeAd.setDislikeCallbackListener(new ATNativeDislikeListener() {
            ...
            public void onAdCloseButtonClick(ATNativeAdView view, ATAdInfo entity) {
                ...
                Toast.makeText(view.getContext(), "[原生List] onAdCloseButtonClick: " + (entity != null ? entity.toString() : ""), Toast.LENGTH_SHORT).show();
