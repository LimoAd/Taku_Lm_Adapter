    ...
    private void initBannerView() {
        ...
        mBannerView.setBannerAdListener(new ATBannerExListener() {
            ...
            public void onDeeplinkCallback(boolean isRefresh, ATAdInfo adInfo, boolean isSuccess) {
                ...
                showToast("[Banner] onDeeplinkCallback: isSuccess=" + isSuccess);
            }

            @Override
            public void onDownloadConfirm(Context context, ATAdInfo adInfo, ATNetworkConfirmInfo networkConfirmInfo) {
                Log.i(TAG, "onDownloadConfirm:" + adInfo.toString() + " networkConfirmInfo:" + networkConfirmInfo);
                showToast("[Banner] onDownloadConfirm: " + (adInfo != null ? adInfo.toString() : ""));
            }
            ...
            public void onBannerLoaded() {
                ...
                showToast("[Banner] onBannerLoaded");
                if (scrollView != null) {
            ...
            public void onBannerFailed(AdError adError) {
                ...
                showToast("[Banner] onBannerFailed: " + (adError != null ? adError.getFullErrorInfo() : ""));
            }
            ...
            public void onBannerClicked(ATAdInfo entity) {
                ...
                showToast("[Banner] onBannerClicked: " + (entity != null ? entity.toString() : ""));
            }
            ...
            public void onBannerShow(ATAdInfo entity) {
                ...
                showToast("[Banner] onBannerShow: " + (entity != null ? entity.toString() : ""));
            }
            ...
            public void onBannerClose(ATAdInfo entity) {
                ...
                showToast("[Banner] onBannerClose: " + (entity != null ? entity.toString() : ""));
            }
            ...
            public void onBannerAutoRefreshed(ATAdInfo entity) {
                ...
                showToast("[Banner] onBannerAutoRefreshed: " + (entity != null ? entity.toString() : ""));
            }
            ...
            public void onBannerAutoRefreshFail(AdError adError) {
                ...
                showToast("[Banner] onBannerAutoRefreshFail: " + (adError != null ? adError.getFullErrorInfo() : ""));
            }
        });
