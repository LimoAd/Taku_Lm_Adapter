    ...
    private void initDrawAdRequest() {
        mATNative = new ATNative(this, placementId, new ATNativeNetworkListener() {
            ...
            public void onNativeAdLoaded() {
                ...
                Toast.makeText(NativeDrawVideoActivity.this, "[Draw视频] onNativeAdLoaded", Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onNativeAdLoadFail(AdError adError) {
                Log.i(TAG, "onNativeAdLoadFail, " + adError.getFullErrorInfo());
                Toast.makeText(NativeDrawVideoActivity.this, "[Draw视频] onNativeAdLoadFail: " + (adError != null ? adError.getFullErrorInfo() : ""), Toast.LENGTH_SHORT).show();
            }
        });
